  ...
  return (
    <>
      ...
      >
            ...
            <>
              <InitialPrompt>
                <div style={{ fontSize: '24px', marginBottom: '12px' }}>
                  Ask me about LA's <span style={{ fontWeight: 800 }}>15-minute city</span> metrics, <span style={{ fontWeight: 800 }}>neighborhood accessibility</span>, and <span style={{ fontWeight: 800 }}>urban amenities</span>.
                </div>
                <div style={{ color: 'rgba(255, 255, 255, 0.6)', fontWeight: 300 }}>
                  I can help you analyze walkability scores, transit access, essential services proximity, and neighborhood livability across Los Angeles.
                </div>
              </InitialPrompt>

              <AnimatedDiv $delay={0.2}>
                <QuestionButton onClick={() => handlePredefinedQuestion("Show me the most walkable neighborhoods")}>
                  Show me the most walkable neighborhoods
                </QuestionButton>
              </AnimatedDiv>

              <AnimatedDiv $delay={0.4}>
                <QuestionButton onClick={() => handlePredefinedQuestion("Where are the best-connected transit hubs?")}>
                  Where are the best-connected transit hubs?
                </QuestionButton>
              </AnimatedDiv>

              <AnimatedDiv $delay={0.6}>
                <QuestionButton onClick={() => handlePredefinedQuestion("Analyze neighborhood accessibility by amenities")}>
                  Analyze neighborhood accessibility by amenities
                </QuestionButton>
              </AnimatedDiv>

              <AnimatedDiv $delay={0.8}>
                <SeeMoreButton onClick={() => handlePredefinedQuestion("Show me more 15-minute city metrics")}>
                  See more
                </SeeMoreButton>
              </AnimatedDiv>
            </>
        ...
        <InputArea>
          <Input 
            placeholder="Ask about LA's 15-minute city metrics..."
            value={inputValue}
