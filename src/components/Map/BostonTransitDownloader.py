...
def download_boston_transit_data():
    api = overpy.Overpass(url='https://overpass.kumi.systems/api/interpreter')
    
    # Boston coordinates split into smaller chunks
    lat_min, lon_min = 42.22, -71.20  # SW corner
    lat_max, lon_max = 42.46, -70.92  # NE corner
    ...
    print("Downloading Boston transit data from OpenStreetMap in chunks...")
    ...
    for category, subcategories in transit_features.items():
        for subcategory, features in subcategories.items():
            if features:  # Only create files for non-empty feature collections
                ...
                filename = f'boston_{category}_{subcategory}.geojson'
